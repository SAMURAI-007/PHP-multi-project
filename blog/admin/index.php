...
$usr->execute();
$udata = $usr->fetchAll(PDO::FETCH_ASSOC);
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Admin CMS</li>
                    </ol>
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-success text-white mb-4">
                                <div class="card-body">Blog posts</div>
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link"
                                        href="#"><?php echo $post->rowCount(); ?></a>
                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php foreach ($pdata as $row => $pitem) { ?>
                                            <tr>
                                                <td><?php echo ++$row; ?></td>
                                                <td><?php echo $pitem['title']; ?></td>
                                                <td><?php
                                                $id = $pitem['writer_id'];
                                                $wrid = $conn->prepare("SELECT `username` FROM `user` WHERE `id` = $id");
                                                $wrid->execute();
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php foreach ($udata as $row => $uitem) { ?>
                                            <tr>
                                                <td><?php echo ++$row; ?></td>
