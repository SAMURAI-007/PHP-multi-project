...
if (isset($_POST["sub"])) {
    ...
    $res = $conn->prepare("INSERT INTO `post` (`title`, `content` , `writer_id`, `image`) VALUES (?,?,?,?)");
    $res->bindValue(1, $title);
    $res->bindValue(2, $content);
    $res->bindValue(3, $writerid);
    $res->bindValue(4, $path);
    $res->execute();
    if ($res) {
    ...
    <div class="hero overlay inner-page bg-primary py-5">
        <div class="container">
            <div class="row align-items-center justify-content-center text-center pt-5">
                <div class="col-lg-6">
                    <h1 class="heading text-white mb-3" data-aos="fade-up">Add a new post</h1>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <form action="#">
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    <input type="file" name="fileToUpload" id="fileToUpload" class="form-control" placeholder="File">
                                </div>
                                <div class="col-12 mb-3">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="widget">
                        ...
                        <p>This Project's template is from start bootstrap. the textarea is powered by CKeditor</p>
                    </div> <!-- /.widget -->
                </div> <!-- /.col-lg-4 -->
        ...
        <div class="row mt-5">
            ...
            -->
                ...
                <p>Copyright &copy;
                    ...
                    </script>. All Rights Reserved. &mdash; Designed
